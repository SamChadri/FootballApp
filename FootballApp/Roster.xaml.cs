...
namespace FootballApp
{
    ...
    /// </summary>
    public sealed partial class Roster : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
           ...
           List<Player> roster =  FootballData.GetPlayers();
        ...
        private void Player_ItemClick(object sender, ItemClickEventArgs e)
        {
            Player athlete = (Player)e.ClickedItem;

            string[] name = athlete.name.Split(" ");

            user clicked_account = UserAccount.GetUserByName(name[0], name[1]);

            Frame.Navigate(typeof(Profile), clicked_account);
