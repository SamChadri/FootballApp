...
namespace FootballApp
{
    ...
    sealed partial class App : Application
    {
        ...
        private async void InitDatabases()
        {
            ...
            bool empty = FootballData.GetTableStatus();
            if (empty)
            {
                Debug.WriteLine("Database empty, inserting default data...");
                SampleData.insertPlayers();
                //If you want insert Games too
                //SampleData.insertGameSamples();
