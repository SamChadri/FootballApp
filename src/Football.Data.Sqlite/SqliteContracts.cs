...
public interface IFootballRepository
{
    ...
    Task<IReadOnlyList<Game>> GetGamesAsync(int seasonId,CancellationToken cancellationToken = default);
    Task<Game> GetGameAsync(int gameId, int seasonId, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<Play>> GetTeamPlaysAsync(int teamId, int seasonId, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<Play>> GetTeamGamePlaysAsync(int teamId, int gameId, int seasonId, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<Play>> GetPlayerGamePlaysAsync(int playerId, int gameId, int seasonId, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<Play>> GetPlayerPlaysAsync(int playerId, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<Play>> GetPositionGamePlaysAsync(string position, int gameId, int seasonId, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<Play>> GetPositionPlaysAsync(string position, int teamId, int seasonId, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<Player>> GetPositionPlayersAsync(string position, int teamId, CancellationToken cancellationToken = default);
