...
public partial class AppShell : Shell
{
    public AppShell()
    {
        ...
        Routing.RegisterRoute(nameof(Views.RosterPage),      typeof(Views.RosterPage));
        Routing.RegisterRoute(nameof(Views.PlayerProfilePage), typeof(Views.PlayerProfilePage));
    }
}
